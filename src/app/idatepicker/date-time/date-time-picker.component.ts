...
export class OwlDateTimeComponent<T> extends OwlDateTime<T>
    ...
    get startAt(): T | null {
        ...
        if (this._dtInput) {
            if (this._dtInput.selectMode === 'single') {
                ...
                this._dtInput.selectMode === 'multipleRange'
            ) {
    ...
    private _multirangeSelected: T[] = [];

    get multirangeSelected() {
        return this._multirangeSelected;
    }

    set multirangeSelected(values: T[]) {
        this._multirangeSelected=values
        this.changeDetector.markForCheck();
    }
